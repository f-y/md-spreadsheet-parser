...
class WitWorld:
    def clean_cell(self, cell: Any = None, schema: Any = None):
        ...
        if schema is not None:
            kwargs["schema"] = unwrap_parsing_schema(schema)
    ...
    def parse_separator_row(self, row: Any = None, schema: Any = None):
        ...
        if schema is not None:
            kwargs["schema"] = unwrap_parsing_schema(schema)
        return [
            convert_alignment_type(x)
            for x in md_spreadsheet_parser.parsing.parse_separator_row(**kwargs)
        ]
    ...
    def parse_sheet(
        ...
        if name is not None:
            kwargs["name"] = name
        if schema is not None:
            kwargs["schema"] = unwrap_multi_table_parsing_schema(schema)
        if start_line_offset is not None:
            kwargs["start_line_offset"] = start_line_offset
    ...
    def scan_tables(self, markdown: Any = None, schema: Any = None):
        ...
        return [
            convert_table(x)
            for x in md_spreadsheet_parser.parsing.scan_tables(**kwargs)
        ]

    def generate_table_markdown(self, table: Any = None, schema: Any = None):
        kwargs = {}
        if table is not None:
            kwargs["table"] = unwrap_table(table)
        if schema is not None:
            kwargs["schema"] = unwrap_parsing_schema(schema)
    ...
    def generate_sheet_markdown(self, sheet: Any = None, schema: Any = None):
        ...
        if sheet is not None:
            kwargs["sheet"] = unwrap_sheet(sheet)
        if schema is not None:
            kwargs["schema"] = unwrap_parsing_schema(schema)
    ...
    def generate_workbook_markdown(self, workbook: Any = None, schema: Any = None):
        ...
        if workbook is not None:
            kwargs["workbook"] = unwrap_workbook(workbook)
        if schema is not None:
            kwargs["schema"] = unwrap_multi_table_parsing_schema(schema)
    ...
    def parse_table_from_file(self, source: Any = None, schema: Any = None):
        ...
        return convert_table(
            md_spreadsheet_parser.loader.parse_table_from_file(**kwargs)
        )
    ...
    def parse_workbook_from_file(self, source: Any = None, schema: Any = None):
        ...
        return convert_workbook(
            md_spreadsheet_parser.loader.parse_workbook_from_file(**kwargs)
        )
    ...
    def scan_tables_from_file(self, source: Any = None, schema: Any = None):
        ...
        return [
            convert_table(x)
            for x in md_spreadsheet_parser.loader.scan_tables_from_file(**kwargs)
        ]
    ...
    def table_to_models(
        self, self_obj: Any, schema_cls: Any = None, conversion_schema: Any = None
    ):
        real_self = unwrap_table(self_obj)
        kwargs = {}
        if schema_cls is not None:
            kwargs["schema_cls"] = resolve_model_class(schema_cls)
        if conversion_schema is not None:
            kwargs["conversion_schema"] = unwrap_conversion_schema(conversion_schema)
        return [
            json.dumps(dataclasses.asdict(x)) for x in real_self.to_models(**kwargs)
        ]
    ...
    def table_update_cell(
        self, self_obj: Any, row_idx: Any = None, col_idx: Any = None, value: Any = None
    ):
        real_self = unwrap_table(self_obj)
        kwargs = {}
